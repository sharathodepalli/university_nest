...
-- Run this in your Supabase SQL Editor to fix the verification function

-- First, completely drop any existing verification functions
DROP FUNCTION IF EXISTS verify_email_token(TEXT);
DROP FUNCTION IF EXISTS verify_email_token(VARCHAR);
...
SELECT 'verify_email_token function created successfully! ✅' as status;
